						...
						<div class="card-body">
							...
							<form  action="includes/users.php" method="post">
								<div class="form-group">
									<input type="email" required autofocus class="form-control" name="email" placeholder="Enter Email">
								</div>
								<div class="form-group">
									<input type="password" required class="form-control" name="password" placeholder="Enter Password">
								</div>
								<div class="form-group">
									<button class="btn btn-primary float-right mr-3" type="submit"> Login </button>
								</div>
							</form>
						</div>
					</div>
